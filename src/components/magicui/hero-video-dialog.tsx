    ...
    <div className={cn("relative", className)}>
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-full mb-16 mt-5 md:mt-26  rounded-md border ring-2 ring-neutral-200 shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8]"
        />
